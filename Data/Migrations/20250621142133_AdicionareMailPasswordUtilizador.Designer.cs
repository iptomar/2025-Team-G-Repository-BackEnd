...
namespace BackEndHorario.Data.Migrations
{
    ...
    [Migration("20250621142133_AdicionareMailPasswordUtilizador")]
    partial class AdicionareMailPasswordUtilizador
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BackEndHorario.Models.Unidades_Curriculares", b =>
                {
                    ...
                    b.Property<string>("DocentePL")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DocenteTP")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("HorasPL")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("SalaPLId")
                        .HasColumnType("int");

                    b.Property<int?>("SalaTPId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BackEndHorario.Models.Unidades_Curriculares", b =>
                {
                    ...
                    b.HasOne("BackEndHorario.Models.Salas", "SalaPL")
                        .WithMany()
                        .HasForeignKey("SalaPLId");

                    b.HasOne("BackEndHorario.Models.Salas", "SalaTP")
                        .WithMany()
                        .HasForeignKey("SalaTPId");
